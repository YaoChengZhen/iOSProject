...
@interface YTranitionTypes ()
/**
 *  动画过渡代理管理的是push还是pop
 */
@property (nonatomic, assign) YTransitiaonNavType type;
...
@end
@implementation YTranitionTypes
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (_type) {
        case YPageCoverTransitionTypePop:
            [self doPopAnimation:transitionContext];
            break;
        case YPageCoverTransitionTypePush:
            [self doPushAnimation:transitionContext];
            break;
        case YPresentOneTransitionTypeDismiss:
            [self dismissAnimation:transitionContext];
            break;
        case YPresentOneTransitionTypePresent:
...
//获取controller
- (UIViewController *)getViewController:(id<UIViewControllerContextTransitioning>)transitionContext byKey:(NSString *)key{
...
- (void)doPushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    UIViewController *fromVC = [self getViewController:transitionContext byKey:UITransitionContextFromViewControllerKey];
    UIViewController *toVC = [self getViewController:transitionContext byKey:UITransitionContextToViewControllerKey];
    //对tempView做动画，避免bug;
